...
<!-- End of Topbar -->
        ...
        ?>
                <tr>
                    ...
                    <td><a href="#" class="crude" data-value="<?php echo $row["id"]; ?>">
        ...
        <div>
            ...
            <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
              ...
              <!--inactive user modal-->
              <div class="modal fade" id="admin_active_form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">Select "Activate user" below if you want to activate it.
                        <div class="container">
                            <!-- <div id="profile">
                                <b id="welcome">Welcome : <i><?php 
                                // echo $_SESSION['email_user']; ?></i></b>
                            ...
                            ?>
                                ...
                                <!-- <div>
                                    <a href="../../php/admin/admin_active.php?id= <?php
                                    //  echo $id; 
                                    ?>"><button type="submit"
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                <!-- <a href="../../php/admin/admin_active.php?id= <?php 
                                                // echo $id; ?>"><button type="submit" -->
                                            class="btn btn-primary" id="submit">Activate user</button></a>
                                            </div>
                                        </div>
                                    </div>
            </div>
