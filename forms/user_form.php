...
header("location: ../php/user/user_welcome.php");
}
...
<body>
	...
	<div class="container">
		...
		<form action="../../php/user/user_login.php" method="post" id="myForm" >
			<div class="form-group">
				<label for="email" id="email_title">Email:</label>
				<span class="error" id="email_error"></span>
				<input type="email" class="form-control" id="email" value="<?php echo $error['email'] ?>"
					placeholder="Enter email" name="user[email]">
			</div>
			<div class="form-group">
				<label for="pwd" id="password_title">Password:</label>
				<input type="password" class="form-control" value="<?php echo $error['password'] ?>" id="password"
			...
			<div class='row'>
				...
				<div class='col-lg-6'>
					<a href="../../forms/admin_form.php"><button type="button" class="btn btn-primary btn-block"
							id="redirect">admin login</button>
					</a></div>
